...
step 1: change the directory to IVADL_rose and delete some directory
...
abs_source_dir = "/data/Mingle/DATASETS/IVADL_rose"
abs_target_dir = "/data/Mingle/DATASETS_after/IVADL_rose/all"
osize = (520, 520)
max_num = 480
...
for label in label_names:
    ...
    if not osp.isdir(tgt_dir):
        os.makedirs(tgt_dir)
    print(f"checking {label} class， will stop if the number of images is more than {max_num}")
