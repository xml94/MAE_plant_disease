"""
download dataset from https://data.mendeley.com/datasets/3f83gxmv57/2
step 1: change the directory to Citrus
...
abs_source_dir = "/data/Mingle/DATASETS/Citrus/"
abs_target_dir = "/data/Mingle/DATASETS_after/CitrusLeaf/raw/"
...
src_dir = osp.join(abs_source_dir, 'Leaves')
list_files = subprocess.run(["cp", "-r", src_dir, abs_target_dir])
# remove Melanose class as it only has 13 images
rm_dir = osp.join(abs_target_dir, 'Melanose')
