"""
download dataset from https://aistudio.baidu.com/aistudio/datasetdetail/98233
...
abs_source_dir = "/data/Mingle/DATASETS/ChineseStrawberry/"
abs_target_dir = "/data/Mingle/DATASETS_after/ChineseStrawberry/all"
...
for i in tqdm(range(values.shape[0])):
    ...
    abs_src_name = osp.join(abs_source_dir, "train", img_name)
